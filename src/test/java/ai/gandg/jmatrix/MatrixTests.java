package ai.gandg.jmatrix.test;

import java.util.Random;

import ai.gandg.jmatrix.Matrix;
import ai.gandg.jmatrix.Permutation;
import static ai.gandg.jmatrix.Matrix.NR;
import static ai.gandg.jmatrix.Matrix.TOL;
import static ai.gandg.jmatrix.BasicUnaryOperation.*;
import static ai.gandg.jmatrix.BasicBinaryOperation.*;
...
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixUnitLT;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixUT;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixEye;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixZero;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixOrtho;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixOrthoCols;
import static ai.gandg.jmatrix.test.MatrixAssert.assertMatrixOrthoOrZeroCols;
...
public class MatrixTests {
  ...
  @Test public void norms() {
    ...
    assertEquals(5.0, Matrix.create(3.0, 0.0, 4.0).norm2(), TOL);
    Matrix m = Matrix.of(new double[]{3.0, Double.NaN, 4.0});
    m.set(0, 1, 0.0);
    assertEquals(5.0, m.norm2(), TOL);

    m = Matrix.create(1.0, 1.5, -0.5, 1.5, NR,
                      2.0, 4.0, -4.0, 0.0, NR,
                      0.5, 3.0, -3.0, 2.0);
    ...
    m = Matrix.of(new double[][]{ // test this form of create
        new double[]{1.0, Double.NaN, -0.5, 1.5},
