...
public class BenchmarkRunner
{
  ...
  private static final String CP = "." + File.separator + "*" + ":target" + File.separator + "*";
  ...
  public void run(long seed, String[] benchmarks, boolean isDebug)
    ...
    if (isDebug) { System.out.println("Debug mode is on."); }
    System.out.println();
    ...
    for (int b = 0; b < benchmarks.length; ++b) {
      ...
      ProcessBuilder pb = new ProcessBuilder(JAVA_CMD,
                                             "-Xms512m", "-Xmx512m",
                                             "-cp", CP,
                                             "ai.gandg.jmatrix_bench.Benchmark",
                                             "ai.gandg.jmatrix_bench." + classname,
                                             "" + isDebug,
                                             "" + seed,
                                             "" + NWARMUPS,
                                             "" + NREPEATS,
